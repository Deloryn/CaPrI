        ...
        <v-dialog @click:outside="clearInputs"
            ...
            <v-form class="whiteBackground" ref="updateProposalForm" v-model="isFormValid">
                <v-container class="table">
                    ...
                    <v-row>
                        <v-col>
                            <v-text-field :label="$i18n.t('proposal.titlePolish') + '*'"
                                          :rules="topicRules"
                                          v-model="topicPolish" />
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col>
                            <v-text-field :label="$i18n.t('proposal.titleEnglish') + '*'"
                                          :rules="topicRules"
                    ...
                    <v-row>
                        <v-col>
                            <v-textarea :value="'Write a description here'"
                    ...
                    <v-row>
                        <v-col>
                            <v-textarea :rules="outputDataRules"
                    ...
                    <v-row>
                        <v-col>
                            <v-textarea :rules="specializationRules"
                        ...
                        <v-col>
                            <v-list>
                                ...
                                <v-list-item v-for="indexNumber in indexNumbers" :key="indexNumber">
                                    <v-list-item-title>
                                        <v-icon @click.stop="deleteIndexNumFromList(indexNumber)"
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <v-btn class="submitButton green"
                                   @click="submit">
