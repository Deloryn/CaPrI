                ...
                <v-dialog v-model="dialog"
                    ...
                    <v-form>
                        <v-container style="background-color: #FFFFFF;">
                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field :value=popup.promoter
                                                  label="Promoter"
                                                  readonly></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                                ...
                                <v-col cols="4">
                                    <v-text-field :value=popup.freeSlots
                                                  label="State"
                                                  readonly></v-text-field>
                                </v-col>
            ...
            <v-col cols="12">
                <v-data-table :headers="headers"
                    ...
                    <template v-slot:item.promoter="{ item }">
                        <span style="float: left; font-size: 24px; font-weight: bold;">{{ item.promoter }}</span>
                    </template>
                    <template v-slot:item.freeSlots="{ item }">
                        <span style="float: left; font-size: 24px; font-weight: bold;">{{ item.freeSlots }}</span>
                    </template>
