<template>
    ...
    <div id="studentBar">
        <v-list-item v-for="(filter, i) in filters"
                     :key="i" style="padding: 0; margin: 0;" class="px-3">

            <v-list-item-action color="blue" style="padding: 0; margin: 0; width: 310px;" class="my-4">
