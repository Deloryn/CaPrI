...
namespace Capri.DataLayer.Migrations
{
    ...
    [Migration("20190831191627_CreateCapriDB")]
    partial class CreateCapriDB
    {
            ...
            modelBuilder.Entity("Capri.DataLayer.Entities.Promoter", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Email = "john.smith@gmail.com", Name = "John Smith", PasswordHash = "AQAAAAEAACcQAAAAEGMbDNer35Vct94F53MhibQzZrhrut1VD0/G4w2uAvwZ8eLjI82JtvsOEwNdKHxA2A==", CanSubmitBachelorProposals = true }
                    );
                });
